        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-6 space-y-12">
            ...
            <div className="space-y-6 pt-12">
              <a href="mailto:snehathomasoff13@gmail.com" className="group block text-xl md:text-2xl font-sitka text-sage-600 hover:text-sage-400 transition-all border-b border-sage-100 pb-4">
                snehathomasoff13@gmail.com
              </a>
              <a href="tel:+917358603399" className="group block text-xl md:text-2xl font-sitka text-sage-600 hover:text-sage-400 transition-all border-b border-sage-100 pb-4">
                +91 73586 03399
              </a>
            </div>
